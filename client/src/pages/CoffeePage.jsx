...
function CoffeePage() {
  ...
  if (loading) {
    return <div className="text-center py-10 text-lg text-white">Loading coffees...</div>;
  }
  ...
  return (
    <div className="px-6 py-10 max-w-7xl mx-auto mt-20">
      <h1 className="text-3xl font-bold text-center mb-8 text-white">Our Coffees</h1>
